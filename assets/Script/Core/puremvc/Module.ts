...
import { _decorator, Component, Node, instantiate, Widget, resources, tween, isValid, game, Vec3, easing } from 'cc';
...
export class Module extends Node {
    ...
    constructor() {
        ...
        this.mask = instantiate(resources.get('prefabs/common/Mask'));
    ...
    protected popView(view: any, showAnimation?: boolean, release?: boolean): void {
        ...
        if (isValid(oldUI)) {
            if (this.lastPopUIName == oldUI.name) {
                Logger.warn(this.getModuleName() + ' uiName相同');
                return;
            }
            ...
            Logger.warn(this.getModuleName + ' oldUI is not valid ');
        }
    }
